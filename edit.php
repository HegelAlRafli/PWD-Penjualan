            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if (isset($_SESSION['pesan'])): ?>
                        <div class="alert alert-<?php echo $_SESSION['tipe']; ?>" role="alert"
                            style="margin-bottom: 20px; padding: 10px; border-radius: 5px; <?php echo $_SESSION['tipe'] == 'success' ? 'background-color: #d4edda; color: #155724;' : 'background-color: #f8d7da; color: #721c24;'; ?>">
                    ...
                    <form method="POST" class="form-vertical" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-muted" style="font-size: 0.85em; margin-left: 10px;">*Biarkan kosong jika
                                tidak ingin mengubah gambar.</span>
                            <script>
