                        ...
                        while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr class="data-row">
                                ...
                                <td>
                                    ...
                                    ?>
                                    <img src="uploads/<?php echo htmlspecialchars($foto); ?>" alt="Img"
                                ...
                                <td class="action-buttons">
                                    ...
                                    <a href="detail_barang.php?id=<?php echo $row['id']; ?>" class="btn-action btn-view"
                                        title="Detail">
                        ...
                        <tr id="noDataRow" style="display: none;">
                            <td colspan="8" class="text-center" style="padding: 20px; color: #666;">
                                <i class="fas fa-search"
                                    style="font-size: 20px; color: #ccc; margin-bottom: 5px; display:block;"></i>
