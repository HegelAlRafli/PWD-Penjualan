                ...
                <table class="data-table" id="tablePegawai">
                    ...
                    <tbody>
                        ...
                        <tr class="data-row">
                            <td><?php echo $no++; ?></td>
                            <td>
                                <strong><?php echo htmlspecialchars(string: $row['id_pegawai']); ?></strong>
                            </td>
                            <td>
                            ...
                            <td class="action-buttons">
                                <a href="detail_pegawai.php?id=<?php echo $row['id_pegawai']; ?>"
                                ...
                                <a href="hapus_pegawai.php?id=<?php echo $row['id_pegawai']; ?>"
                                    ...
                                    onclick="return confirm('Yakin hapus pegawai ini?')"><i
